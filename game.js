...
function renderHelp(tab='cultivation'){
  $$('.help-tabs button').forEach(button=>button.classList.toggle('active',button.dataset.helpTab===tab));const pages={
    ...
    body:helpCard('獨立煉體',['煉體境界不受練氣境界限制，也不消耗修為；只需滿足淬鍊度與自身試煉條件。','基礎鍛體安全省料；藥浴鍛體可卸除負荷並舒緩傷勢；極限鍛體收益最高，但風險會隨負荷上升。','體力與肉身負荷每分鐘各恢復或消退1點；鍛體室需先正式開啟煉體之路。'])+helpCard('傷勢與肉身試煉',['擦傷降低淬鍊度收益；內傷提高鍛體體力消耗並降低試煉氣血；筋傷降低試煉閃避並禁止極限鍛體。','傷勢只會改變策略，不會完全封鎖修行；也可等待自然痊癒或消耗材料立即療傷。','小層在淬鍊度滿後直接突破；每十層的大境界需通過肉身試煉，失敗保留淬鍊度但會留下傷勢。'])+helpCard('肉身特性',['玉骨降低極限鍛體受傷率；鳴髓縮短傷勢時間；曜身提高試煉氣血。','擎嶽降低試煉傷害；撼霄降低療傷材料；鎮陸滿足凡界煉體飛升條件。']),
