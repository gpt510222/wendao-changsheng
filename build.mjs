...
for (const file of ["index.html", "manifest.webmanifest", "styles.css", "q-style.css", "partner-system.js", "game.js"]) {
...
const shell = ["index.html", "manifest.webmanifest", "styles.css", "q-style.css", "partner-system.js", "game.js"];
